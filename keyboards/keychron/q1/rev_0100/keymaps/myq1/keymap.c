...
[L_BASE] = LAYOUT_ansi_82(
     ...
     FN_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   KC_BSPC,            KC_INS,
...
[Z_FN] = LAYOUT_ansi_82(
     ...
     KC_TRNS,  RGB_RMOD, RGB_VAD,  RGB_HUD,  RGB_SAD,  RGB_SPD,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,            KC_TRNS,
     KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  TG(N_FN),           KC_TRNS,  KC_TRNS,
     KC_Z,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_TRNS,  KC_TRNS,  MO(S_FN), KC_TRNS,  KC_TRNS,  KC_TRNS),
...
void rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    ...
    */
    ...
    // Navigation layer leds
    if (layer_state_is(N_FN)) {

        RGB_MATRIX_INDICATOR_SET_COLOR(1, 0, 255 ,255); // KC_F1
        RGB_MATRIX_INDICATOR_SET_COLOR(2, 0, 255 ,255); // KC_F2
        RGB_MATRIX_INDICATOR_SET_COLOR(3, 0, 255 ,255); // KC_F3
        RGB_MATRIX_INDICATOR_SET_COLOR(4, 0, 255 ,255); // KC_F4
        RGB_MATRIX_INDICATOR_SET_COLOR(5, 0, 255 ,255); // KC_F5
        RGB_MATRIX_INDICATOR_SET_COLOR(6, 0, 255 ,255); // KC_F6
        RGB_MATRIX_INDICATOR_SET_COLOR(7, 0, 255 ,255); // KC_F7
        RGB_MATRIX_INDICATOR_SET_COLOR(8, 0, 255 ,255); // KC_F8
        RGB_MATRIX_INDICATOR_SET_COLOR(9, 0, 255 ,255); // KC_F9
        RGB_MATRIX_INDICATOR_SET_COLOR(10, 0, 255 ,255); // KC_F10
        RGB_MATRIX_INDICATOR_SET_COLOR(11, 0, 255 ,255); // KC_F11
        RGB_MATRIX_INDICATOR_SET_COLOR(12, 0, 255 ,255); // KC_F12
        ...
        RGB_MATRIX_INDICATOR_SET_COLOR(1, 0, 0, 0); // KC_F1
        RGB_MATRIX_INDICATOR_SET_COLOR(2, 0, 0, 0); // KC_F2
        RGB_MATRIX_INDICATOR_SET_COLOR(3, 0, 0, 0); // KC_F3
        RGB_MATRIX_INDICATOR_SET_COLOR(4, 0, 0, 0); // KC_F4
        RGB_MATRIX_INDICATOR_SET_COLOR(5, 0, 0, 0); // KC_F5
        RGB_MATRIX_INDICATOR_SET_COLOR(6, 0, 0, 0); // KC_F6
        RGB_MATRIX_INDICATOR_SET_COLOR(7, 0, 0, 0); // KC_F7
        RGB_MATRIX_INDICATOR_SET_COLOR(8, 0, 0, 0); // KC_F8
        RGB_MATRIX_INDICATOR_SET_COLOR(9, 0, 0, 0); // KC_F9
        RGB_MATRIX_INDICATOR_SET_COLOR(10, 0, 0, 0); // KC_F10
        RGB_MATRIX_INDICATOR_SET_COLOR(11, 0, 0, 0); // KC_F11
        RGB_MATRIX_INDICATOR_SET_COLOR(12, 0, 0, 0); // KC_F12
